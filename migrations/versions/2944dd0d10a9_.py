...
Revision ID: 2944dd0d10a9
Revises: 
Create Date: 2019-11-09 00:40:08.584246
...
def upgrade():
    ...
    sa.Column('allowable_x_tenant_ids', sa.ARRAY(sa.String(length=50)), nullable=False),
